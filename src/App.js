...
// ---------------------------------------------------------
// TUS CLAVES DE FIREBASE (Limpias para Vercel)
// ---------------------------------------------------------
...
export default function App() {
  ...
  const exportarPDF = () => {
    ...
    // Forzar un tamaño de computadora (1200px) para evitar recortes
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-20">
        ...
        <div id="area-impresion" className="bg-slate-100 p-2 space-y-4">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            ...
            {/* Div controlado para evitar el scroll en PDF */}
